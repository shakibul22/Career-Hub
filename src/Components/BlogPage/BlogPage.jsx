...
const BlogPage = () => {
    return (
        ...
        <div className='shadow p-5'>
            <h3 className='font-semibold mb-4'>a. When should you use context API?</h3>
        ...
        <div className='shadow p-5'>
            <h3 className='font-semibold mb-4'>b. What is a custom hook?</h3>
        ...
        <div className='shadow p-5'>
            <h3 className='font-semibold mb-4'>c. What is useRef?</h3>
        ...
        <div className='shadow p-5'>
            <h3 className='font-semibold mb-4'> d. What is useMemo?</h3>
